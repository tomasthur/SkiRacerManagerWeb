        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight">
          ...
          <span className="text-mediumBlue"> MANAGER</span>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 relative z-10">
                ...
                <a href="#" className="inline-block hover:scale-110 hover:brightness-110 transition-all duration-300 cursor-pointer relative z-20">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="Download from App Store" className="h-12 w-auto" />
                </a>
              </div>
            </motion.div>
      ...
      <section id="cta" className="relative py-24 scroll-mt-24">
        <div className="container-max">
          <div className="glass rounded-2xl p-8 md:p-12 text-center">
            ...
            <p className="text-lightBlue/85 mt-2">Available on Google Play and App Store</p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a href="#" className="inline-block hover:scale-105 transition-transform duration-300">
                <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="Download from App Store" className="h-14 w-auto" />
              </a>
            </div>
          </div>
        </div>
